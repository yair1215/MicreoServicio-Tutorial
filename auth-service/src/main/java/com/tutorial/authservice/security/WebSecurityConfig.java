...
import com.tutorial.authservice.security.jwt.AuthEntryPointJwt;
import com.tutorial.authservice.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
               ...
               // .antMatchers(HttpMethod.GET,"/authorize/user/**").hasRole("ADMIN")
